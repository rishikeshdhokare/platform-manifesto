...
|--------|-------|---------|---------|
| Add test coverage for orders with null service_type | @{lead-engineer} | 2024-12-01 | ORD-9876 |
| Enforce canary deployment for ALL releases - no bypass | @platform-team | 2024-11-20 | PLAT-4321 |
| Add data seeding to staging with legacy order shapes | @{engineer} | 2024-12-15 | ORD-9877 |
| Update on-call runbook to include status page update step | @{engineer} | 2024-11-18 | ORD-9878 |
